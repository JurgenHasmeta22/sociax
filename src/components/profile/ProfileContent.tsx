...
const PrivacyIcon = ({ privacy }: { privacy: string }) => {
    const Icon = privacy === "Public" ? Globe : privacy === "FriendsOnly" ? Users : Lock;
    ...
    return (
        <div>
            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-muted-foreground mb-4">
                    ...
                    {user.birthday && (
                        <span className="flex items-center gap-1">
                            ...
                            Joined {format(new Date(user.birthday), "MMMM yyyy")}
                        </span>
                    )}
                </div>
                    ...
                    <div className="max-w-2xl mx-auto pb-8">
                        <Card>
                            <CardContent className="pt-6 space-y-4">
                                <div>
                                    <h3 className="font-semibold mb-3 text-primary">Overview</h3>
                                    <div className="space-y-3 text-sm">
                                        ...
                                        {user.birthday && (
                                            <div className="flex gap-3">
                                                <span className="text-muted-foreground w-24 shrink-0">Birthday</span>
                                                <span>
                ...
                {activeTab === "Photos" && (
                    <div className="pb-8">
                        {user.posts.filter((p) => p.media.length > 0).length === 0 ? (
