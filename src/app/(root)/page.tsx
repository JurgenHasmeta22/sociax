...
const FEATURES = [
	...
	},
	{
		...
		description: "Create or join groups around topics you care about.",
	...
	},
	{
		...
		description: "Find and RSVP to events happening near you or online.",
			...
			<section className="relative overflow-hidden py-20 md:py-32 px-4">
				...
				<div className="max-w-4xl mx-auto text-center space-y-8">
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-3">
						<Button
							size="lg"
							className="text-base px-8 h-12 gap-2 font-bold w-full sm:w-auto"
							asChild
						>
							<Link href="/register">
								Create your account
